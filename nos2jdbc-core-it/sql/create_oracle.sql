...
CREATE TABLE TENSE (ID NUMERIC PRIMARY KEY,DATE_DATE DATE, DATE_TIME DATE, DATE_TIMESTAMP TIMESTAMP, CAL_DATE DATE, CAL_TIME TIMESTAMP, CAL_TIMESTAMP DATE, SQL_DATE DATE, SQL_TIME TIMESTAMP, SQL_TIMESTAMP TIMESTAMP, LOCAL_DATE DATE, LOCAL_TIME DATE, LOCAL_DATE_TIME TIMESTAMP, OFFSET_DATE_TIME TIMESTAMP WITH TIME ZONE);
...
CREATE TABLE PATTERN (VALUE1 VARCHAR2(10));

CREATE TABLE ID_GENERATOR(PK VARCHAR2(20) NOT NULL PRIMARY KEY, VALUE1 INTEGER NOT NULL);
CREATE TABLE MY_ID_GENERATOR(MY_PK VARCHAR2(20) NOT NULL PRIMARY KEY, MY_VALUE INTEGER NOT NULL);
CREATE TABLE AUTO_STRATEGY(ID NUMERIC(8) PRIMARY KEY, VALUE1 VARCHAR2(10));
CREATE TABLE IDENTITY_STRATEGY(ID NUMERIC(8) PRIMARY KEY, VALUE1 VARCHAR2(10));
CREATE TABLE SEQUENCE_STRATEGY(ID NUMERIC(8) NOT NULL PRIMARY KEY, VALUE1 VARCHAR2(10));
CREATE TABLE SEQUENCE_STRATEGY2(ID NUMERIC(8) NOT NULL PRIMARY KEY, VALUE1 VARCHAR2(10));
CREATE TABLE TABLE_STRATEGY(ID NUMERIC(8) NOT NULL PRIMARY KEY, VALUE1 VARCHAR2(10));
CREATE TABLE TABLE_STRATEGY2(ID NUMERIC(8) NOT NULL PRIMARY KEY, VALUE1 VARCHAR2(10));
