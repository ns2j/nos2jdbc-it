...
CREATE TABLE LARGE_OBJECT(ID INT NOT NULL PRIMARY KEY, NAME NVARCHAR(20), LARGE_NAME NVARCHAR(MAX), BYTES VARBINARY(2000), LARGE_BYTES VARBINARY(MAX), DTO VARBINARY(2000), LARGE_DTO VARBINARY(MAX));
CREATE TABLE TENSE (ID INT PRIMARY KEY,DATE_DATE DATE, DATE_TIME TIME, DATE_TIMESTAMP DATETIME, CAL_DATE DATE, CAL_TIME TIME, CAL_TIMESTAMP DATETIME, SQL_DATE DATE, SQL_TIME TIME, SQL_TIMESTAMP DATETIME, LOCAL_DATE DATE, LOCAL_TIME TIME, LOCAL_DATE_TIME DATETIME, OFFSET_DATE_TIME DATETIMEOFFSET);
...
CREATE TABLE PATTERN (VALUE1 VARCHAR(10));

CREATE TABLE ID_GENERATOR(PK VARCHAR(20) NOT NULL PRIMARY KEY, VALUE1 INTEGER NOT NULL);
CREATE TABLE MY_ID_GENERATOR(MY_PK VARCHAR(20) NOT NULL PRIMARY KEY, MY_VALUE INTEGER NOT NULL);
CREATE TABLE AUTO_STRATEGY(ID INT IDENTITY PRIMARY KEY, VALUE1 VARCHAR(10));
CREATE TABLE IDENTITY_STRATEGY(ID INT IDENTITY PRIMARY KEY, VALUE1 VARCHAR(10));
CREATE TABLE SEQUENCE_STRATEGY(ID INT NOT NULL PRIMARY KEY, VALUE1 VARCHAR(10));
CREATE TABLE SEQUENCE_STRATEGY2(ID INT NOT NULL PRIMARY KEY, VALUE1 VARCHAR(10));
CREATE TABLE TABLE_STRATEGY(ID INT NOT NULL PRIMARY KEY, VALUE1 VARCHAR(10));
CREATE TABLE TABLE_STRATEGY2(ID INT NOT NULL PRIMARY KEY, VALUE1 VARCHAR(10));
CREATE TABLE TABLE_STRATEGY5(ID INT NOT NULL PRIMARY KEY, VALUE1 VARCHAR(10));
...
INSERT INTO TENSE VALUES (1, '2005-02-14', '12:11:10', '2005-02-14 12:11:10', '2005-02-14', '12:11:10', '2005-02-14 12:11:10', '2005-02-14', '12:11:10', '2005-02-14 12:11:10', '2005-02-14', '12:11:10', '2005-02-14 12:11:10', '2005-02-14 12:11:10 +00:00');
