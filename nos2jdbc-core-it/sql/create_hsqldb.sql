...
CREATE TABLE TENSE (ID INTEGER NOT NULL PRIMARY KEY,DATE_DATE DATE, DATE_TIME TIME, DATE_TIMESTAMP TIMESTAMP, CAL_DATE DATE, CAL_TIME TIME, CAL_TIMESTAMP TIMESTAMP, SQL_DATE DATE, SQL_TIME TIME, SQL_TIMESTAMP TIMESTAMP, LOCAL_DATE DATE, LOCAL_TIME TIME, LOCAL_DATE_TIME TIMESTAMP, OFFSET_DATE_TIME TIMESTAMP WITH TIME ZONE);
...
CREATE TABLE AUTO_STRATEGY(ID INTEGER NOT NULL IDENTITY, VALUE1 VARCHAR(10));
CREATE TABLE IDENTITY_STRATEGY(ID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY, VALUE1 VARCHAR(10));
