...
CREATE TABLE TENSE (ID INTEGER PRIMARY KEY,DATE_DATE DATE, DATE_TIME TIME, DATE_TIMESTAMP DATETIME, CAL_DATE DATE, CAL_TIME TIME, CAL_TIMESTAMP DATETIME, SQL_DATE DATE, SQL_TIME TIME, SQL_TIMESTAMP DATETIME, LOCAL_DATE DATE, LOCAL_TIME TIME, LOCAL_DATE_TIME DATETIME, OFFSET_DATE_TIME DATETIME);
